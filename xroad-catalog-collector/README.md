...
X-Road Catalog Collector can be configured by creating a copy of the [application.yaml](/src/main/resources/application.yaml) file. 
...
* For all Liquibase related configurations supported by Spring Boot, search for `liquibase` under [Data Migration Properties](https://docs.spring.io/spring-boot/appendix/application-properties/index.html#appendix.application-properties.data-migration) section
...
| [spring.liquibase.enabled](https://docs.spring.io/spring-boot/appendix/application-properties/index.html#application-properties.data-migration.spring.liquibase.enabled)             | Y        | `true`                                           | Use `true` to execute liquibase changesets against database during startup.                                                                                                                                                                            | 1.0.0 |
| [spring.liquibase.change-log](https://docs.spring.io/spring-boot/appendix/application-properties/index.html#application-properties.data-migration.spring.liquibase.change-log)       | Y        | `classpath:db/changelog/db.changelog-master.xml` | Do not modify. Used value points to changesets maintained by collector module.                                                                                                                                                                         | 1.0.0 |
...
| [spring.liquibase.show-summary](https://docs.spring.io/spring-boot/appendix/application-properties/index.html#application-properties.data-migration.spring.liquibase.show-summary)   | N        | `verbose`                                        |                                                                                                                                                                                                                                                        | 1.0.0 |
| [spring.liquibase.contexts](https://docs.spring.io/spring-boot/appendix/application-properties/index.html#application-properties.data-migration.spring.liquibase.contexts)           | N        | `users`                                          | Available values are `users` and `fi`. `users` is used to create new users (a user for collector module and a user for lister module). `fi` is used to apply DDLs that are Finland specific. Multiple values can be comma separated, e.g., `users,fi`. | 1.0.0 |
...
#### Spring Boot framework configurations
...
#### Parameters used by common features
...
| `xroad-catalog.urls.security-server-host`              | Y        |                                              | A parameter for setting the security server host to connect to. e.g., http://security.server.host:5000                                                                                                                                                                                                       | 1.0.0 |
...
#### Parameters used by Finland-specific features
