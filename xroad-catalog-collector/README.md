...
| `xroad-catalog.tasks.client-connect-timeout-seconds`   | `10`                                         | A parameter for setting the connect timeout in seconds of the HTTP and SOAP calls made to the Security Server. Every call must be time-bounded, otherwise a collection cycle might never properly finish.                                                                 | 1.0.0 |
