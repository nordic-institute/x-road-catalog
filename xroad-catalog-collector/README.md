...
|--------------------------------------------------------|----------|----------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------|
| `xroad-catalog.urls.list-clients-host`                 | N        | `${xroad-catalog.urls.security-server-host}` | A parameter for setting the security server host to be used to get list of clients. Default value references `xroad-catalog.urls.security-server-host`.                                                                                                                                                      | 1.0.0 |
| `xroad-catalog.urls.webservices-endpoint`              | N        | `${xroad-catalog.urls.security-server-host}` | A parameter for setting the security server host to be used to get list of OpenAPI services, SOAP services, and list of services. Default value references `xroad-catalog.urls.security-server-host`.                                                                                                        | 1.0.0 |
...
| Parameter                                                   | Required | Defaults | Description                                                                                                                                                                                                                                                                                                                      | Since |
|-------------------------------------------------------------|----------|----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------|
| `xroad-catalog.country.fi.enabled`                          | N        | `false`  | A parameter to enable/disable Finland specific features. If `false`, then all Finland specific features are disabled and all related parameters becomes irrelevant (not used)                                                                                                                                                    | 1.0.0 |
