...
| `xroad.configuration-client.proxy-configuration-backup-cron`   | * * * * * ? 2099                    | Cron expression for the Security Server automatic backup job run by the embedded configuration client. The lister image has no backup script, so the default is a cron expression that never fires.                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | 1.0.0 |
...
| [server.port](https://docs.spring.io/spring-boot/appendix/application-properties/index.html#application-properties.server.server.port)                                                               | `8070`     | The API port, the same port the RPM packages used.                                                                                                            | 4.0.0 |
